...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title" >Hello
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
       ...
       I'm Le Le Wei.
        ...
        <p className="home__descritpion">
        Hi there! I'm a soon-to-graduate full-stack developer who's deeply passionate about coding and design. With a knack for both front-end finesse and back-end logic, I'm excited to bring creative ideas to life in the digital world. Let's connect and create something extraordinary!
        </p>
